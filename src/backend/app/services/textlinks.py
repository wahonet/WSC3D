...
def linked_references(db: Session, stone_id: str, source: str) -> list[AnnotationReference]:
...
def linked_annotations(db: Session, stone_id: str, source: str,
...
def save_text_with_links(db: Session, stone_id: str, source: str,
