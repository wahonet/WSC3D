...
export interface ReferenceExcerpt {
  field: 'pre_iconographic' | 'iconographic'
  start: number
  end: number
  text: string
}
export interface AnnotationExcerptPatch extends ReferenceExcerpt { reference_id: number }
...
export interface DocumentInfo {
  id: number
  code: string
  /** core 核心10本 / extension 扩展库 */
  collection: LibraryCollection
  /** 扩展库：对应 extension_books.id */
  book_id: string
  title: string
  authors: string
  year: string
