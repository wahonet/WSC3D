      ...
      <div className="home-inner">
        <div>
          ...
          <p>
            ...
            <b>分割</b>选取画面区域，<b>标注</b>填写名称、概念与图像描述，<b>文献</b>为标注关联原文；
        ...
        <div className="keys">
          ...
          <span><Kbd>↑</Kbd><Kbd>↓</Kbd>结构树上下 <Kbd>Enter</Kbd>定位 <Kbd>Ctrl+S</Kbd>保存表单</span>
          <span><Kbd>Esc</Kbd>取消绘制 / 取消选中</span>
          <span><Kbd>Del</Kbd>删除选中</span>
          {stones.length === 0 && <span className="muted">暂无画像石，请先在 resources/stones/ 中整理素材并登记档案。</span>}
        </div>
      </div>
    </div>
  )
